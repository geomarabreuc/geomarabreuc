...
1. Learn machine learning, mathematics & programming with Claude.
   • Finish CS50x & CS50P.
2. Develop trading algorithms & raise capital with prop firms.
3. Grow an audience online while building.
4. Deploy a simple app to test vibe coding (outside everything else).
